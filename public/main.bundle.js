...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n   background-color: black;\n   color: white;\n}\n\n.grid {\n   display: grid;\n   height: calc(100vh - 20px);\n   grid-template-columns: repeat(2, 50%);\n   grid-template-rows: 100%;\n   margin: 1em;\n}\n.item1 {\n   grid-column: 1;\n}\n.item2 {\n   grid-column: 2;\n}\n", "",{"version":3,"sources":["webpack://./src/site.css"],"names":[],"mappings":"AAAA;GACG,uBAAuB;GACvB,YAAY;AACf;;AAEA;GACG,aAAa;GACb,0BAA0B;GAC1B,qCAAqC;GACrC,wBAAwB;GACxB,WAAW;AACd;AACA;GACG,cAAc;AACjB;AACA;GACG,cAAc;AACjB","sourcesContent":["body {\n   background-color: black;\n   color: white;\n}\n\n.grid {\n   display: grid;\n   height: calc(100vh - 20px);\n   grid-template-columns: repeat(2, 50%);\n   grid-template-rows: 100%;\n   margin: 1em;\n}\n.item1 {\n   grid-column: 1;\n}\n.item2 {\n   grid-column: 2;\n}\n"],"sourceRoot":""}]);
// Exports
...
var Mana;
(function (Mana) {
    Mana[Mana["Colorless"] = 0] = "Colorless";
    Mana[Mana["White"] = 2] = "White";
    Mana[Mana["Blue"] = 4] = "Blue";
    Mana[Mana["Black"] = 8] = "Black";
    Mana[Mana["Red"] = 16] = "Red";
    Mana[Mana["Green"] = 32] = "Green";
})(Mana = exports.Mana || (exports.Mana = {}));
...
function RunTests() {
    ...
    let card2 = new card_1.Card("2", [mana_1.Mana.Red, mana_1.Mana.Colorless, mana_1.Mana.Red]);
    console.assert(card2.IsCastable(mana));
    let card3 = new card_1.Card("3", [mana_1.Mana.Red, mana_1.Mana.Colorless, mana_1.Mana.Red]);
    console.assert(card3.IsCastable(mana));
    let card4 = new card_1.Card("4", [mana_1.Mana.Red, mana_1.Mana.Colorless, mana_1.Mana.Red, mana_1.Mana.Green]);
    console.assert(card4.IsCastable(mana));
    let card5 = new card_1.Card("5", [mana_1.Mana.Colorless]);
    console.assert(card5.IsCastable(mana));
    let card6 = new card_1.Card("6", [mana_1.Mana.Colorless, mana_1.Mana.Colorless, mana_1.Mana.White, mana_1.Mana.Colorless]);
    console.assert(card6.IsCastable(mana));
    let cardUncastable1 = new card_1.Card("uncastable1", [mana_1.Mana.Blue]);
    console.assert(!cardUncastable1.IsCastable(mana));
    let cardUncastable2 = new card_1.Card("uncastable2", [mana_1.Mana.Red, mana_1.Mana.Red, mana_1.Mana.Red]);
    console.assert(!cardUncastable2.IsCastable(mana));
    let cardUncastable3 = new card_1.Card("uncastable3", [mana_1.Mana.Colorless, mana_1.Mana.Colorless, mana_1.Mana.Colorless, mana_1.Mana.Colorless, mana_1.Mana.Colorless]);
...
function GetOpeningHandStats() {
    ...
    for (let i = 0; i < num; i++) {
        ...
        for (let c = 0; c < state.hand.length; c++) {
            ...
            if (card instanceof land_1.Land) {
                landNumber++;
            }
        }
